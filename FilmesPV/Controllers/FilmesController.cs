...
namespace FilmesPV.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,Autor,CategoriaId,Preco,Resumo,Imagem,Id,DataCadastro")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,Autor,CategoriaId,Preco,Resumo,Imagem,Id,DataCadastro")] Filme filme)
        {
            if (id != filme.Id)
            {
                return NotFound();
